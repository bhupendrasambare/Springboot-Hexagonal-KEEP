    ...
    <div>
        <div className="d-flex flex-column justify-content-between vh-100-50 max-250 p-3 pb-0 ps-0 text-light">
            <div className="d-flex flex-column">
                <div 
                className={("my-2 d-flex justify-conent-around cursor-pointer" + ((activePage == ActivePage.NOTES)?" rounded-pill rounded-start bg-warning-local":""))}
                ...
                <div className={("my-2 d-flex justify-conent-around cursor-pointer" + ((activePage == ActivePage.REMINDER)?" rounded-pill rounded-start bg-warning-local":""))}
                ...
                <div className={("my-2 d-flex justify-conent-around cursor-pointer" + ((activePage == ActivePage.IMPORTANT)?" rounded-pill rounded-start bg-warning-local":""))}
                ...
                <div className={("my-2 d-flex justify-conent-around cursor-pointer" + ((activePage == ActivePage.EDITLABELS)?" rounded-pill rounded-start bg-warning-local":""))}
                ...
                <div className={("my-2 d-flex justify-conent-around cursor-pointer" + ((activePage == ActivePage.ARCHIVE)?" rounded-pill rounded-start bg-warning-local":""))}
                ...
                <div className={("my-2 d-flex justify-conent-around cursor-pointer" + ((activePage == ActivePage.BIN)?" rounded-pill rounded-start bg-warning-local":""))}
